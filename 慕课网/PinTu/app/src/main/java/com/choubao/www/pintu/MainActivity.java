...
//        Bitmap bigBm = BitmapFactory.decodeResource(getResources(), R.drawable.bg);
        Bitmap bigBm = BitmapFactory.decodeResource(getResources(), R.drawable.pintu);
        // 小方块边长
